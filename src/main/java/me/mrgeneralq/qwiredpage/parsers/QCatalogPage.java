...
public class QCatalogPage {
    ...
    public QCatalogPage(HPacket packet) {
    ...
    public QCatalogPage(int pageId, String catalogType, String layoutCode, int offerId, boolean acceptSeasonCurrencyAsCredits) {
        this.pageId = pageId;
        this.catalogType = catalogType;
        this.layoutCode = layoutCode;
